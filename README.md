...
Обладаю отличным знанием JS (опыт работы с React, в небольших проектах для управления состоянием лучше использовать React useContext hook, Jest лучшая библиотека для тестов).

PHP на среднем уровне, писал парсеры, интеграция формы обратной связи с MySQL и Telegram.
(Использовал Larvel в целях ознакомления)

Смогу доказать знание принципов ООП.

Работаю с GIT (недавно открыл для себя GitHub Actions, на мой взгляд отличная технология)
